...
public class StopSearchActivity extends Activity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Log.logInit(this);
        // Log.appendLog("StopSearchActivity onCreate");
        ...
        txt.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View arg0, int keyCode, KeyEvent event) {
                ...
                if (keyCode != 66 && event.getAction() == KeyEvent.ACTION_UP) {
                    new AutoSearchTimer(1000, 2000).start();
                    return false;
                }
                return false;
            }
    ...
    protected void onStop() {
        super.onStop();
        // Log.appendLog("StopSearchActivity onStop");
    ...
    protected void onDestroy() {
        super.onDestroy();
        // Log.appendLog("StopSearchActivity onDestroy");
